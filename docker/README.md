...
Images are made up of file system changes and metadata, Each layer is uniquely identified and only stored once on a host, this saves storage space on host and transfer time on pysh/pull, a container is just a single read/write layer on top of image.
